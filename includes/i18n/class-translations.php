...
final class Translations {
	...
	private static function dictionary(): array {
		return [
			...
			'Site-wide vertical-swipe announcement strip. Drop the [header_top] shortcode at the top of your theme — same width as the parent container, vertical auto-rotation between slides.' => 'Faixa de avisos site-wide com swipe vertical. Cole o shortcode [header_top] no topo do seu tema — mesma largura do container pai, rotação vertical automática entre slides.',
			'Save settings'           => 'Salvar configurações',
			'Paste this once at the very top of your theme (Elementor header, Customizer, code snippet — wherever your theme lets you).' => 'Cole isto uma vez no topo do seu tema (header do Elementor, Customizer, code snippet — onde seu tema permitir).',
			'Behavior'                => 'Comportamento',
			'How the strip rotates and how tall it sits in the page.' => 'Como a faixa rotaciona e qual a altura na página.',
			'Enable Header Top'       => 'Ativar Header Top',
			'When off, the [header_top] shortcode renders nothing — even if there are active slides.' => 'Quando desligado, o shortcode [header_top] não renderiza nada — mesmo havendo slides ativos.',
			'Height (px)'             => 'Altura (px)',
			'Background color'        => 'Cor de fundo',
			'Autoplay delay (ms)'     => 'Intervalo de reprodução (ms)',
			'Transition speed (ms)'   => 'Velocidade da transição (ms)',
			'Slides'                  => 'Slides',
			'Drag to reorder. Click a thumbnail to replace the image. Toggle to pause without deleting.' => 'Arraste para reordenar. Clique na imagem para substituí-la. Use o switch para pausar sem excluir.',
			'No slides yet — add one to make the strip render.' => 'Nenhum slide ainda — adicione um para a faixa começar a renderizar.',
			'Select Header Top slides' => 'Selecionar slides do Header Top',
			'Replace slide image'     => 'Substituir imagem do slide',
			'Describe the slide…'     => 'Descreva o slide…',
			'Slide duplicated.'       => 'Slide duplicado.',
			'Duplicate slide'         => 'Duplicar slide',
			'Delete slide'            => 'Excluir slide',
			'Delete slide?'           => 'Excluir slide?',
			'The slide will be removed from the Header Top. The image stays in your media library.' => 'O slide será removido do Header Top. A imagem permanece na biblioteca de mídia.',
			'Failed to load Header Top.' => 'Falha ao carregar Header Top.',
			'Failed to add slide.'    => 'Falha ao adicionar slide.',
			'Failed to delete slide.' => 'Falha ao excluir slide.',
			'Site announcements'      => 'Avisos do site',
			'Open announcement'       => 'Abrir aviso',
			'Univer Smart Carousel: the Header Top has no active slides.' => 'Univer Smart Carousel: o Header Top não tem nenhum slide ativo.',
			'Could not create slide. Make sure the image_id points to a valid attachment.' => 'Não foi possível criar o slide. Verifique se o image_id aponta para um anexo válido.',
			'Slide not found.'        => 'Slide não encontrado.',

			// Badges page
			'Badges'                  => 'Badges',
			'Offer badges'            => 'Badges de oferta',
			'Rename and re-swatch the terms of the pa_badge-ofertas attribute without leaving this page.' => 'Renomeie e troque a imagem dos termos do atributo pa_badge-ofertas sem sair desta tela.',
			'Refresh'                 => 'Atualizar',
			'WooCommerce attribute'   => 'Atributo WooCommerce',
			'Every term in this attribute is listed below. Click a card to edit its name and swatch image.' => 'Todos os termos deste atributo aparecem abaixo. Clique em um card para editar o nome e a imagem.',
			'No badges found'         => 'Nenhuma badge encontrada',
			'The taxonomy pa_badge-ofertas exists but has no terms yet.' => 'A taxonomia pa_badge-ofertas existe mas ainda não tem termos.',
			'Edit badge'              => 'Editar badge',
			'products'                => 'produtos',
			'Badge name'              => 'Nome da badge',
			'This is what appears under the product card and in the URL slug stays the same.' => 'É o nome que aparece abaixo do card do produto. O slug da URL permanece o mesmo.',
			'Swatch image'            => 'Imagem da amostra',
			'Remove'                  => 'Remover',
			'Prefer the native WordPress screen?' => 'Prefere a tela nativa do WordPress?',
			'Open term editor'        => 'Abrir editor de termo',
			'Choose the new swatch image' => 'Escolher a nova imagem',
			'Nothing changed.'        => 'Nada mudou.',
			'Badge updated.'          => 'Badge atualizada.',
			'Failed to load badges.'  => 'Falha ao carregar badges.',
			'Failed to update badge.' => 'Falha ao atualizar badge.',
			'Taxonomy "%s" does not exist on this site.' => 'A taxonomia "%s" não existe neste site.',
			'Badge not found.'        => 'Badge não encontrada.',
			'The selected attachment is not an image.' => 'O anexo selecionado não é uma imagem.',
